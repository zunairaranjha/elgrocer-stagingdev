describe API::V1::Orders::DeleteShopper, type: :request do
  let!(:retailer) do
  ...
  describe 'Delete /orders/accept in database' do
    context "when params are correct" do
      subject(:request_response) {
        delete '/api/v1/orders/shopper', params: { order_id: order1.id }, headers: { "Authentication-Token" => shopper.authentication_token, "From-Spec" => true }
        response
      }
