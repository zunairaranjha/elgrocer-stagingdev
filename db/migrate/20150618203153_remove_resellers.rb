class RemoveResellers < ActiveRecord::Migration
  def up
    remove_index :retailers, :email
    remove_index :retailers, :reset_password_token
    remove_index :retailers, :authentication_token
