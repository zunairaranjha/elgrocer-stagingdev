module Notifications
    module AppleNotifications
        ...
        def push(registration_id, info, alert=nil, badge=nil, sound='default', expiry=nil, content_available=nil, category=nil)
            params = {
    ...
    module GoogleMessaging
        ...
        def push(registration_id, data, collapse_key=nil, delay_while_idle=nil, time_to_live=nil)
            params = {
                  "device_tokens": [registration_id],
