module API
  module V1
    module Orders
      module Entities
        class RecentEntity < API::BaseEntity
          root 'orders', 'order'
          ...
          expose :approved_at, documentation: { type: 'String', desc: 'Date of order approved' }, format_with: :string
          expose :processed_at, documentation: { type: 'String', desc: 'Date of order processed' }, format_with: :string
          expose :accepted_at, documentation: { type: 'String', desc: 'Date of order accepted' }, format_with: :string
          ...
          expose :total_price_without_discount, as: :total_order_amount, documentation: { type: 'Float', desc: "Total order amount"}, format_with: :float
          ...
          # def retailer
          #   # retailer = Retailer.find(object.retailer_id)
          #   retailer = object.retailer
          #   shopperAddress = ShopperAddress.find_by_id(object.shopper_address_id) if object.shopper_address_id
