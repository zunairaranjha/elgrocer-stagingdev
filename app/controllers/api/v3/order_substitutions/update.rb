    ...
    module OrderSubstitutions
      class Update < Grape::API
        ...
        resource :order_substitutions do
          ...
          put do
            ...
            products.each do |product|
              ...
              proposal = ProductProposal.find_by(order_id: order.id, product_id: product[:substituting_product_id]) unless order_substitution.present?
        ...
        resource :order_substitutions do
          ...
          put '/update' do
            # TODO: Need Much Optimisation and Code refactoring
            target_user = current_employee || current_shopper
