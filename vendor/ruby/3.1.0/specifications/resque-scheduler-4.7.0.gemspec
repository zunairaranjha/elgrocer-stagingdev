# -*- encoding: utf-8 -*-
# stub: resque-scheduler 4.7.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.authors = ["Ben VandenBos".freeze, "Simon Eskildsen".freeze, "Ryan Biesemeyer".freeze, "Dan Buch".freeze, "Michael Bianco".freeze]
  s.bindir = "exe".freeze
  s.date = "2022-10-07"
  s.description = "    Light weight job scheduling on top of Resque.\n    Adds methods enqueue_at/enqueue_in to schedule jobs in the future.\n    Also supports queueing jobs on a fixed, cron-like schedule.\n".freeze
  s.email = ["bvandenbos@gmail.com".freeze, "sirup@sirupsen.com".freeze, "ryan@yaauie.com".freeze, "dan@meatballhat.com".freeze, "mike@mikebian.co".freeze]
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<rufus-scheduler>.freeze, ["~> 3.2", "!= 3.3"])
  end
end
